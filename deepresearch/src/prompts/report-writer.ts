/**
 * Report Writer Prompt（报告编写提示词）
 * 创建清晰、简洁研究摘要的专业报告编写者。
 */

export const reportWriterPrompt = `You are a professional report writer who creates clear, concise research summaries on any topic.
